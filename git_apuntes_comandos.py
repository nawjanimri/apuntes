   ...
   # Conceptos básicos:
    ...
    > git add <nombre del archivo>  # Añade un archivo al control de código
    > git commit -m "first commit"  # Primer commit
    > git remote add origin <URL del repositorio remoto> # Añade el respositorio remoto 
                                    # y lo defines con el nombre "origin"
    > git remote push -u origin master # Subes el código de la rama por defecto del repositorio 
                                    # local ("master") al respositorio remoto ("origin")

    # Push an existing repository from the command line:
    ----------------------------------------------------
    > git remote add origin <URL del repositorio remoto> # Añade el respositorio remoto 
                                    # y lo defines con el nombre "origin"
    > git push -u origin master     # Subes el código de la rama por defecto del repositorio 
                                    # local ("master") al respositorio remoto ("origin")
